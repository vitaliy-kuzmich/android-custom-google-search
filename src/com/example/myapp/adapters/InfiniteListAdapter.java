...
// data or a Progressbar
    ...
    public InfiniteListAdapter(Activity activity, List<T> list) {
        mActivity = activity;
        dataList = list;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (dataRow == null) {
            dataRow = mActivity.getLayoutInflater().inflate(R.layout.item, parent, false);
        }
        dataRow = getDataRow(position, dataRow, parent);
